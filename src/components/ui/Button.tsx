    ...
    return (
      <button
        ...
        className={cn(
          ...
          {
            'bg-amber-700 text-white hover:bg-amber-800 focus:ring-amber-700': variant === 'primary',
            ...
            'border border-amber-700 text-amber-700 hover:bg-amber-50 focus:ring-amber-700': variant === 'outline',
          },
          {
